...
public class ModelVariants : MonoBehaviour
{
    ...
    public void Select(int index) {
        ...
        Renderer _prevRenderer = _currenSelected.GetComponent<Renderer>();
        _currenSelected = _models[index];
        Renderer _renderer = _currenSelected.GetComponent<Renderer>();
        _renderer.material = _prevRenderer.material;
